...
export default function EishockeyPage() {
  const leagues = [
    {
      name: "Deutsche Eishockey Liga (DEL)",
      description: "Die höchste Spielklasse im deutschen Eishockey mit 14 Teams",
      image: "/ice-hockey-game-arena.jpg",
    },
    {
      name: "NHL",
      description: "Die nordamerikanische Profiliga - die beste Eishockeyliga der Welt",
      image: "/ice-hockey-world-championship-arena.jpg",
    },
    {
      name: "IIHF Weltmeisterschaft",
      description: "Das jährliche internationale Turnier der besten Nationalmannschaften",
      image: "/ice-hockey-game-arena.jpg",
    },
    {
      name: "Champions Hockey League",
      description: "Europäischer Klubwettbewerb der Top-Teams",
      image: "/ice-hockey-world-championship-arena.jpg",
    },
  ]
    ...
    <main>
      ...
      <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        <div
          ...
          style={{ backgroundImage: "url('/ice-hockey-game-arena.jpg')" }}
        />
        <div className="relative z-20 container mx-auto px-4 py-20 text-center text-primary-foreground">
          ...
          <h1 className="text-5xl md:text-6xl font-bold mb-6 text-balance">Eishockey</h1>
          <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto text-primary-foreground/90 text-balance">
            Rasante Action auf dem Eis - von der DEL bis zur NHL
          </p>
          <Button asChild size="lg" className="bg-secondary text-secondary-foreground hover:bg-secondary/90">
            <Link href="/kontakt?sport=eishockey">
              Tickets anfragen
      ...
      <section className="container mx-auto px-4 py-16 md:py-24">
        <div className="mb-12">
          ...
          <p className="text-lg text-muted-foreground text-balance">
            Entdecken Sie die besten Eishockey-Wettbewerbe weltweit
          </p>
        </div>
              ...
              <div className="relative">
                <div className={`relative overflow-hidden ${index === 0 ? "h-96" : "h-72"}`}>
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-8 z-20">
                    ...
                    >
                      <Link href={`/kontakt?sport=eishockey&league=${encodeURIComponent(league.name)}`}>
                        Tickets anfragen
